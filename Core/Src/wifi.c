...
char wifiTxBuffer[1024];
char wifiRxBuffer[1024];
...
WIFI_StatusTypeDef WIFI_MQTTClientInit(WIFI_HandleTypeDef* hwifi){
	...
	int msgLength = 0;
	msgLength = sprintf(wifiTxBuffer, "PM=0,\r");
	WIFI_SendATCommand(hwifi, wifiTxBuffer, msgLength+1, wifiRxBuffer, WIFI_RX_BUFFER_SIZE);
	msgLength = sprintf(wifiTxBuffer, "PM=1,\r");
	WIFI_SendATCommand(hwifi, wifiTxBuffer, msgLength+1, wifiRxBuffer, WIFI_RX_BUFFER_SIZE);
	msgLength = sprintf(wifiTxBuffer, "PM=2,\r");
	WIFI_SendATCommand(hwifi, wifiTxBuffer, msgLength+1, wifiRxBuffer, WIFI_RX_BUFFER_SIZE);
	msgLength = sprintf(wifiTxBuffer, "PM=3,\r");
	WIFI_SendATCommand(hwifi, wifiTxBuffer, msgLength+1, wifiRxBuffer, WIFI_RX_BUFFER_SIZE);
	msgLength = sprintf(wifiTxBuffer, "PM=4,\r");
	WIFI_SendATCommand(hwifi, wifiTxBuffer, msgLength+1, wifiRxBuffer, WIFI_RX_BUFFER_SIZE);
	msgLength = sprintf(wifiTxBuffer, "PM=5,\r");
	WIFI_SendATCommand(hwifi, wifiTxBuffer, msgLength+1, wifiRxBuffer, WIFI_RX_BUFFER_SIZE);
	msgLength = sprintf(wifiTxBuffer, "PM=6,\r");
	WIFI_SendATCommand(hwifi, wifiTxBuffer, msgLength+1, wifiRxBuffer, WIFI_RX_BUFFER_SIZE);
	// Set publish topic
